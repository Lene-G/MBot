...
//             double ang_error_deriv = (angle_error - ang_error_last_) / dt;
//             ang_error_last_ = angle_error;

//             cmd.linear.x = 0.0;  // Don't move forward while rotating
//             cmd.angular.z = Kp_ang * angle_error + Ki_ang * ang_error_sum_ + Kd_ang * ang_error_deriv;
...
//             double lin_error_deriv = (distance - lin_error_last_) / dt;
//             lin_error_last_ = distance;

//             // PID for angular correction (keep heading toward target)
//             ang_error_sum_ += angle_error * dt;
//             ang_error_sum_ = std::clamp(ang_error_sum_, -integral_limit, integral_limit);
//             double ang_error_deriv = (angle_error - ang_error_last_) / dt;
//             ang_error_last_ = angle_error;

//             cmd.linear.x = Kp_lin * distance + Ki_lin * lin_error_sum_ + Kd_lin * lin_error_deriv;
//             cmd.angular.z = Kp_ang * angle_error + Ki_ang * ang_error_sum_ + Kd_ang * ang_error_deriv;
...
//         cmd.angular.z = std::clamp(cmd.angular.z, -3.14, 3.14);
